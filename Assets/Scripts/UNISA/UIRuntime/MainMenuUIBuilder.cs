...
namespace UNISA.UIRuntime
{
    public class MainMenuUIBuilder : MonoBehaviour
    {
        ...
        {
            Build();
            UIManager.Instance.mainMenuRoot = root.gameObject;
        ...
        private void Build()
        {
            ...
            root = new GameObject("MainMenuRoot").AddComponent<RectTransform>();
            ...
            CreateAccentButton("Play", new Vector2(0.5f, 0.6f), () => GameManager.Instance.StartGame());
            CreateButton("Settings", new Vector2(0.5f, 0.5f), () => GameManager.Instance.SetState(GameState.Settings));
            CreateButton("Credits", new Vector2(0.5f, 0.4f), () => GameManager.Instance.SetState(GameState.Credits));
            CreateButton("Exit", new Vector2(0.5f, 0.3f), () => Application.Quit());
        }
        ...
        private void CreateButton(string label, Vector2 anchor, UnityEngine.Events.UnityAction onClick)
        {
            ...
            rt.anchorMin = anchor; rt.anchorMax = anchor; rt.sizeDelta = new Vector2(200, 50);
            ...
            text.text = label; text.alignment = TextAnchor.MiddleCenter; text.color = ThemeManager.Instance.Palette.Text; text.fontSize = 24;
        ...
        private void CreateAccentButton(string label, Vector2 anchor, UnityEngine.Events.UnityAction onClick)
        {
            ...
            var textGO = new GameObject("Text");
            var text = textGO.AddComponent<Text>();
            text.text = label; text.alignment = TextAnchor.MiddleCenter; text.color = ThemeManager.Instance.Palette.Background; text.fontSize = 24;
